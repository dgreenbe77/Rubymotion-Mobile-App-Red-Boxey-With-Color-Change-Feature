class AppDelegate
  ...
  def application(application, didFinishLaunchingWithOptions:launchOptions)
    ...
    @box_color = UIColor.redColor
    @window.backgroundColor = UIColor.whiteColor

    @red_view = UIView.alloc.initWithFrame(CGRect.new([10,10], [100,100]))
    @red_view.backgroundColor = @box_color
    ...
    @color_field.frame = CGRect.new([@red_view.frame.origin.x + @red_view.frame.size.width + 10, @red_view.frame.origin.y + @color_field.frame.size.height], @color_field.frame.size)
